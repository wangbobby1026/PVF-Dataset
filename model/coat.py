...
class ParallelBlock(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, sizes: List[Tuple[int, int]]):
        ...
        # print(cur2.shape, cur3.shape, cur4.shape)
        # print(cur2.shape, upsample3_2.shape, upsample4_2.shape)
        # print(cur3.shape, upsample4_3.shape, downsample2_3.shape)
        # print(cur4.shape, downsample3_4.shape, downsample2_4.shape)
